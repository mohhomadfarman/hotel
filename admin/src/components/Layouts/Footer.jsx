        ...
        <div>
          <div className="footer-logo">
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="280px" height="auto" viewBox="0 0 1090.000000 136.000000" preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,136.000000) scale(0.100000,-0.100000)" fill="#B6191F"
    stroke="none">
...
101 -257 106 -49 2 -100 -1 -128 -9z" />
          ...
          <ul>
            <li><a href="#">Luxury Hotel And Resorts</a></li>
            <li><a href="#">Luxury Hotels Magazines</a></li>
            <li><a href="#">Nominate Your Hotel</a></li>
      ...
      <div className="col-md-2">
        <div>
          ...
          <ul>
            ...
            <li><a href="#">Collaborative Advantages</a></li>
          </ul>
        </div>
      </div>
      <div className="col-md-2">
        <div>
          <div className="right-line"><h2>Advertiser</h2></div>

          <ul>
            <li><a href="#">Distribution</a></li>
            <li><a href="#">Publish News</a></li>
            <li><a href="#">Media Packs</a></li>
            <li><a href="#">Advertise with us</a></li>
            <li><a href="#">List Your hotels</a></li>
